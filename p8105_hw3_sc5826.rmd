...
smoothed_mims = nhanes |> 
  ggplot(aes(x = hour, y = mims, color = sex)) +
  geom_smooth() +
  scale_x_continuous(breaks = seq(0, 24, by = 6)) +
  facet_grid(education~.)

median_mims/smoothed_mims
```
Plotting both the median of MIMS data across all participants at each time point and a smoothed line show similar trends. Activity is at the lowest between 0-6 hours. From 6-12 hours, activity rises and stays pretty flat through hour 18. From hours 18-24, activity decreases. At the less than high school level, male and female activity track closely. However at the equivalent to and more than high school levels, female activity appears higher than male activity at around hour 8. At other hours, male and female activity is pretty close. 